...
const schema = z.object({
  ...
  password: z.string().min(8, { message: "At least 8 characters" }).max(100)
    ...
    .refine((p) => /[0-9]/.test(p), { message: "Add a number" })
    .refine((p) => /[^A-Za-z0-9]/.test(p), { message: "Add a symbol (!@#$...)" }),
  confirm: z.string(),
        ...
        <div className="space-y-1.5">
          ...
          <div className="relative">
            ...
            <Input id="name" type="text" autoComplete="name" placeholder="Jane Doe"
              value={name} onChange={(e) => setName(e.target.value)} className="pl-9" aria-invalid={!!errors.name} />
          </div>
