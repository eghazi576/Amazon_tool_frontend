...
const categories = [
  {
    title: "General — About Aurix",
    faqs: [
      {
        q: "What is Aurix?",
        a: "Aurix is a web-based Amazon FBA research platform that helps sellers find profitable products, analyze competition, and validate wholesale brand opportunities. It fetches live market data from Keepa — including price history, Best Seller Rank (BSR), FBA seller counts, and profit margins — and produces a scored buy/no-buy verdict for every ASIN you analyze.",
      },
      {
        q: "Who is Aurix built for?",
        a: "Aurix is built for Amazon FBA sellers operating in wholesale, online arbitrage (OA), and private label models. Whether you are sourcing products from distributors, scanning retail clearance, or vetting new brands to carry, Aurix gives you the data and scoring you need to make faster, better decisions.",
      },
      {
        q: "How is Aurix different from Jungle Scout or Helium 10?",
        a: "Jungle Scout and Helium 10 are broad Amazon seller suites covering keyword research, listing optimization, PPC, and more. Aurix is laser-focused on product and brand viability scoring. Its Brand Intelligence module scores brands across 11 criteria — including IP complaint history, hazmat catalog percentage, MAP enforcement, and FBA seller count — a workflow that general tools do not offer. Aurix is also built on live Keepa data, giving you 90-day price history, BSR trends, and real-time FBA seller counts.",
      },
      {
        q: "What data sources does Aurix use?",
        a: "Aurix pulls live data from the Keepa API, which aggregates real-time Amazon marketplace data including price history, Best Seller Rank, review counts, FBA/FBM offer counts, and Amazon's own 'Bought in past month' sales badge. For IP complaint history, Aurix links to ip-alert.com and who.is for domain and business registration verification.",
      },
      {
        q: "Is Aurix free to use?",
        a: "Aurix currently offers access to registered users. Sign up to start researching products and evaluating brands. Pricing details are available after registration.",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    faqs: [
      ...
      },
      {
        ...
        a: "Yes. Enter any ASIN from the brand and click Submit. Aurix fetches the brand name, category, average rating, review count, FBA seller count, monthly sales estimate, hazmat status, and adult product flag automatically. Fields that cannot be auto-detected — such as IP complaint count, mass takedown history, brand website, and business registration — require manual entry with guidance links provided.",
      },
      {
        q: "What is MAP and why does it affect my sourcing decision?",
        a: "MAP stands for Minimum Advertised Price. Brands that aggressively enforce MAP require all sellers to list at or above a fixed minimum price. This protects your margin (no race to the bottom) but also means you must comply or risk being cut off from the brand's supply. Aurix flags MAP enforcement as a signal to be aware of — not a disqualifier, since MAP enforcement is generally a sign of a healthy, in-demand brand.",
      },
      {
        q: "How do I check IP complaints for a brand?",
        a: "Aurix links directly to IP-Alert.com from the IP Complaints field. IP-Alert.com is a community-maintained database of brands known to file IP complaints, counterfeit claims, or cease-and-desist letters against Amazon sellers. Enter the number of complaints you find and Aurix factors it into the score. Zero or one complaint in the last 12 months passes; two or more loses 10 points.",
      },
    ],
  },
  {
    ...
    faqs: [
      {
        ...
        a: "Sales estimates are approximations, not guarantees. The most accurate source is Amazon's own 'Bought in past month' badge (fetched via Keepa), which reflects real purchases in the last 30 days. When that is unavailable, Aurix counts actual BSR drops in the 30-day data series — each drop generally corresponds to at least one sale. All estimates carry inherent uncertainty; use them as directional signals alongside BSR trend and review velocity.",
      },
      {
        q: "How current is the price and BSR data?",
        a: "Keepa tracks Amazon prices and BSR in near real-time, typically updating every 1–6 hours depending on the product's sales velocity. When you analyze an ASIN in Aurix, it fetches the most current snapshot available from Keepa at that moment, plus the full 90-day historical series.",
      },
      {
        q: "Why might some fields show no data?",
        a: "Some products — especially newly launched ASINs or products with very low sales velocity — do not have enough historical data in Keepa for all fields to populate. In those cases, Aurix shows null rather than an incorrect value, and falls back to alternative calculation methods where possible. A missing data field is useful information in itself: it often signals a product too new or too inactive to confidently evaluate.",
      },
    ],
  },
  {
    ...
    faqs: [
      ...
      },
      {
        ...
        a: "You can reach the Aurix team by email at support@aurix.app. We respond to all enquiries within 24 hours on business days.",
      },
    ],
  },
];
      ...
      <main className="container mx-auto max-w-3xl px-4 pb-24 pt-32">
        ...
        <div className="mb-12 text-center">
          ...
          <p className="mt-3 text-muted-foreground">
            Everything you need to know about Aurix — Amazon FBA product and brand research.
          </p>
        </div>
        ...
        <div className="mt-16 rounded-2xl border border-primary/20 bg-primary/5 p-8 text-center">
          ...
          <p className="mt-2 text-sm text-muted-foreground">
            Reach us at{" "}
            <a href="mailto:support@aurix.app" className="text-primary underline underline-offset-2">
              support@aurix.app
            </a>{" "}
