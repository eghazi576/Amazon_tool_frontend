...
const features = [
  {
    ...
    description: "Put in an ASIN, get back 90 days of real market data. Price history, BSR trends, FBA seller count, ratings — everything in one place.",
  ...
  },
  {
    ...
    description: "A scoring system built around how real FBA sellers evaluate products. 15 criteria, weighted by importance, instant verdict.",
  ...
  },
  {
    ...
    description: "Enter your cost and see your real margins. Referral fees, FBA fees, storage, and inbound costs are all calculated for you.",
