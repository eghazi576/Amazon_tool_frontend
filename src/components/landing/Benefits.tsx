...
const benefits = [
  { icon: Clock,    title: "Research in one place, not ten tabs", text: "Researching one product used to take 20 minutes of tab-switching. WholesaleOS pulls it all into a single scored verdict." },
